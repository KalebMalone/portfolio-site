...
const Projects = () => {
    const projectList = [
        ...
        },
        {
            ...
            description: 'A car parts application where a user can buy car products inspired by performancebyie.com, built with full CRUD features. And email handling'
        },
        {
            name: 'Core Flow',
